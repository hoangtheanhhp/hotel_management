...
<div class="banner-top">
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SUMMER.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUM <span>MER</span><p class="logo_w3l_agile_caption">Your Dreamy Hotel</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SUM MER</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SUM MER</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/teams1.jpg" width="100" height="100" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams2.jpg" width="100" height="100" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams3.jpg" width="100" height="100" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams4.jpg" width="100" height="100" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams5.jpg" width="100" height="100" alt=" " class="img-responsive" />
					</li>
					</ul>
      ...
      <div class="plans-section" id="rooms">
				...
				<div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img src="images/<?=$r->image?>" alt=" " class="img-responsive" />
							<h4><?=$r->room_type?></h4>
						</div>
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><?=$r->price?><span>VNĐ</span></h3>						
								<a href="request.php?id=<?=$r->room_type_id?>" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
